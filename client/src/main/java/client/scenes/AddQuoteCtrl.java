...
public class AddQuoteCtrl {
    ...
    /**
     * Constructor
     * @param server type ServerUtils
     * @param mainCtrl type MainCtrl
     */
    @Inject
    ...
    /**
     * checks for exceptions while calling add quote
     */
    public void ok() {
        try {
    ...
    /**
     * getter for quote
     * @return a new quote with attributes p q
     */
